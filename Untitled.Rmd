...
review_scores_rating_plot <- ggplot(data = listing, aes(x = reviews_per_month, y = number_of_reviews)) +
 geom_point(aes(colour = host_is_superhost)) + 
 scale_colour_viridis_d(name="Is Superhost?") + 
 theme_minimal() + 
...
# library(tidyr)
# 
# name_df_sentiment_count <- name_df %>%
#   inner_join(get_sentiments("bing")) %>%
#   count(host_is_superhost, sentiment) %>%
